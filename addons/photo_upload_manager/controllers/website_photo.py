...
class WebsitePhoto(http.Controller):
    ...
    def upload_photo(self, **kwargs):
        ...
        try:
            ...
            # Crea il record in photo.order
            # Imposta il name come l'order.name e salva il product_id per poterlo mostrare in foto.order
            ...
            # Reindirizza alla pagina carrello
